...
export default function Main() {
  return (
    <section className="text-gray-600 body-font flex items-center md:min-h-[calc(100vh)] mt-[80px] lg:mb-[52px] lg:mt-0">
      <div className="max-w-6xl mx-auto flex px-5 md:flex-row flex-col items-center">
        <div className="lg:flex-grow md:w-1/2 md:ml-4 p-6 flex flex-col md:items-start md:text-left items-center text-center">
          ...
          <div className="flex flex-col md:flex-row gap-2 justify-center">
            <a
              className="px-5 py-3 mt-2 font-medium text-white transition duration-500 ease-in-out transform border rounded-lg bg-primary brightness-100 hover:brightness-125"
              href={DOWNLOAD_URL}
            >
              <span className="justify-center">Download Chrome Extension</span>
            </a>
            <a
              className="px-5 py-3 mt-2 font-medium transition duration-500 ease-in-out transform border rounded-lg bg-neutral-50 hover:bg-neutral-200"
