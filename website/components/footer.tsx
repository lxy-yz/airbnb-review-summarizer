export default function Footer() {
  return (
    <footer className="">
      <div className="pt-6 py-12 w-full flex justify-center">
        <a
          ...
          target="_blank"
        >
          <img src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=397254&theme=light" alt="Airbnb&#0032;Review&#0032;Summarizer - Summarize&#0032;listing&#0032;reviews&#0032;to&#0032;be&#0032;useful | Product Hunt" width="250" height="54" />
        </a>
      </div>
